...
from functions import oferecer_plano_anual, oferecer_desconto_primeira_aula, motivar_envio_fotos, atualizar_envio_fotos

app = Flask(__name__)

GEMINI_API_KEY = os.environ.get('GEMINI_API_KEY')
genai.configure(api_key=GEMINI_API_KEY)
magical_if = genai.GenerativeModel("gemini-1.5-flash", generation_config={"temperature": 0.5}, 
                        tools=[oferecer_plano_anual, oferecer_desconto_primeira_aula, motivar_envio_fotos, atualizar_envio_fotos])
